...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("ins_TUSER", 2, hls_in, 3, "axis", "in_data", 1),
	Port_Property("ins_TLAST", 1, hls_in, 4, "axis", "in_data", 1),
	Port_Property("ins_TID", 5, hls_in, 5, "axis", "in_data", 1),
	Port_Property("ins_TDEST", 6, hls_in, 6, "axis", "in_data", 1),
	...
	Port_Property("outs_TUSER", 2, hls_out, 10, "axis", "out_data", 1),
	Port_Property("outs_TLAST", 1, hls_out, 11, "axis", "out_data", 1),
	Port_Property("outs_TID", 5, hls_out, 12, "axis", "out_data", 1),
	Port_Property("outs_TDEST", 6, hls_out, 13, "axis", "out_data", 1),
};
