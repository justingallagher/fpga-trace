...
#ifndef __tri_intersect_data_array_H__
#define __tri_intersect_data_array_H__
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(tri_intersect_data_array_ram) {
...
SC_MODULE(tri_intersect_data_array) {
...
tri_intersect_data_array_ram* meminst;


SC_CTOR(tri_intersect_data_array) {
meminst = new tri_intersect_data_array_ram("tri_intersect_data_array_ram");
